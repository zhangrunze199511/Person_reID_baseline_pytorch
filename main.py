...
parser.add_argument('--data_dir',default='../data/DukeMTMC-reID/pytorch',type=str, help='training dir path')
parser.add_argument('--test_dir',default='../data/DukeMTMC-reID/pytorch',type=str, help='./test_data')
